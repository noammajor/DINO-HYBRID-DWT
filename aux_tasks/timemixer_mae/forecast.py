"""Downstream in-domain forecasting eval for the MAE-pretrained TimeMixer encoder.

Loads a pretrained encoder (encoder.* from an MAE checkpoint), attaches a fresh
...
from model import TimeMixerForecast
